...
export function SocialPill() {
  return (
    <div className="z-30 flex place-items-center space-x-1 rounded-full bg-dark-primary px-3 py-1.5">
      ...
      <a href={siteMetadata.webflow} target="_blank" rel="noopener noreferrer">
        {/* Webflow "W" icon */}
        <svg
          className="h-6 w-6 text-gray-400 hover:text-gray-300"
          viewBox="0 0 24 24"
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M17.8 6.4c-1.1 3.4-2.4 6.4-3.9 9.1-.8-2.8-1.3-5.8-1.6-9.1H8.9C8.4 9.8 7.6 12.8 6.6 15.5 6 12.7 5.7 9.7 5.6 6.4H2c.3 5.4 1.6 9.8 3.7 13.2h3.5c1-2.7 1.9-5.7 2.6-8.8.5 3.1 1.2 6.1 2.2 8.8h3.5c2.3-3.4 3.9-7.9 4.7-13.2h-4.4z"/>
        </svg>
