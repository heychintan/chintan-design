...
export default async function BlogPage({
  ...
  return (
    <div className="mt-14 space-y-16 md:mt-16">
      <title>Blog | Chintan Savaliya</title>
      <GridWrapper>
        <div className="mx-auto max-w-2xl pb-8 pt-2 md:pb-10">
          <h1 className="text-center text-4xl font-medium leading-tight tracking-tighter text-text-primary md:text-6xl md:leading-[64px]">
            {category
